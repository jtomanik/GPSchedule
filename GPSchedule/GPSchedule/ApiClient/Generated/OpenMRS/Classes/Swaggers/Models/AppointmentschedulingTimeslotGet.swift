...
open class AppointmentschedulingTimeslotGet: JSONEncodable {
    ...
    public init(uuid: String?=nil, display: String?=nil, startDate: Date?=nil, endDate: Date?=nil, appointmentBlock: AppointmentschedulingAppointmentblockGet?=nil, countOfAppointments: Double?=nil, unallocatedMinutes: Double?=nil, voided: Bool?=nil) {
        self.uuid = uuid
