...
open class ConceptNameGet: JSONEncodable {
    ...
    public init(uuid: String?=nil, display: String?=nil, name: String?=nil, locale: String?=nil, localePreferred: Bool?=nil, conceptNameType: ConceptNameType?=nil) {
        self.uuid = uuid
